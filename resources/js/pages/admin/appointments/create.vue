    ...
    <AdminSidebarLayout>
        <div class="flex h-full flex-1 flex-col gap-6 rounded-xl p-6 max-w-3xl">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold tracking-tight">Schedule Appointment</h1>
                    <p class="text-muted-foreground mt-1">Pre-register a visitor for an upcoming visit.</p>
                </div>
            </div>
                ...
                <div class="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 p-6 shadow-sm">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2 md:col-span-2">
                            ...
                            <Input v-model="form.date_time" type="datetime-local" required class="w-full md:w-1/2" />
