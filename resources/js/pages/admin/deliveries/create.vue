...
<template>
    <Head title="Log Delivery" />
    <AdminSidebarLayout>
        <div class="flex h-full flex-1 flex-col gap-6 rounded-xl p-6">
            <div>
                <h1 class="text-2xl font-bold tracking-tight">Log a Delivery</h1>
                <p class="text-muted-foreground mt-1">Record a new incoming package or delivery.</p>
            </div>
            
            <Card class="max-w-2xl">
                <CardHeader>
                    <CardTitle>Delivery Information</CardTitle>
                    <CardDescription>Enter details about who the package is from and who it's for.</CardDescription>
                </CardHeader>
                <CardContent>
                    <form @submit.prevent="submit" class="space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="space-y-2">
                                ...
                                <Input id="from_whom" v-model="form.from_whom" required placeholder="John Smith" />
                            ...
                            <div class="space-y-2">
                                ...
                                <Input id="company" v-model="form.company" placeholder="FedEx, Amazon, etc." />
                            ...
                            <div class="space-y-2 md:col-span-2">
                                ...
                                <Input id="for_whom" v-model="form.for_whom" required placeholder="Employee Name" />
                            ...
                            <div class="space-y-2 md:col-span-2">
                                ...
                                <Input id="package_details" v-model="form.package_details" placeholder="Box, Envelope, 2 items, etc." />
