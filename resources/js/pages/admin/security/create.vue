...
const submit = () => {
    form.post('/admin/security');
};
</script>

<template>
    <Head title="Add to Watchlist" />
    <AdminSidebarLayout>
        <div class="flex h-full flex-1 flex-col gap-6 rounded-xl p-6 max-w-3xl">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold tracking-tight text-red-600 dark:text-red-500">Add to Watchlist</h1>
                    <p class="text-muted-foreground mt-1">Flag a person to alert security upon their arrival.</p>
                </div>
            </div>
                ...
                <div class="rounded-xl border border-red-200 dark:border-red-900/30 bg-white dark:bg-zinc-950 p-6 shadow-sm">
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea v-model="form.reason" rows="4" class="w-full rounded-md border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 px-3 py-2 text-sm shadow-sm focus:outline-none focus:ring-1 focus:ring-red-500" placeholder="Provide details on why this individual is flagged..." required></textarea>
